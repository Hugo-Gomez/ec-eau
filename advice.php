      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-10 text-center heading-section heading-section-white ftco-animate">
            <h2 class="title">Pour réduire les couts et le gachis de l'eau</h2>
            <p class="description">
              Nous vous proposons quelques conseils généraux afin de vous aider à optimiser
              votre consommation d'eau, pour faire un geste pour la planète mais aussi pour
              vous et vos économies.
            </p>
          </div>
        </div>
      </div>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(images/bg_4.jpg);">
    	<div class="container">
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            <h2 class="mb-4">Quelques chiffres sur la consommation de l'eau</h2>
            <span class="subheading">La consommation d'eau en France c'est..</span>
          </div>
        </div>
        ...
        <div class="row no-gutters">
          <div class="col-md-4 ftco-animate py-5 nav-link-wrap">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link px-4 active" id="v-pills-master-tab" data-toggle="pill" href="#v-pills-master" role="tab" aria-controls="v-pills-master" aria-selected="true"><i class="fas fa-shower"></i> Bain et Douche</a>

              <a class="nav-link px-4" id="v-pills-tooth-tab" data-toggle="pill" href="#v-pills-tooth" role="tab" aria-controls="v-pills-tooth" aria-selected="false"><i class="fas fa-tooth"></i> Brossage de dents</a>

              <a class="nav-link px-4" id="v-pills-dish-tab" data-toggle="pill" href="#v-pills-dish" role="tab" aria-controls="v-pills-dish" aria-selected="false"><i class="fas fa-utensils"></i> Vaisselle</a>

              <a class="nav-link px-4" id="v-pills-clothes-tab" data-toggle="pill" href="#v-pills-clothes" role="tab" aria-controls="v-pills-clothes" aria-selected="false"><i class="fas fa-socks"></i> Linge</a>

              <a class="nav-link px-4" id="v-pills-garden-tab" data-toggle="pill" href="#v-pills-garden" role="tab" aria-controls="v-pills-garden" aria-selected="false"><i class="fab fa-pagelines"></i> Jardin</a>

              <a class="nav-link px-4" id="v-pills-car-tab" data-toggle="pill" href="#v-pills-car" role="tab" aria-controls="v-pills-car" aria-selected="false"><i class="fas fa-car"></i> Voiture</a>

              <a class="nav-link px-4" id="v-pills-drink-tab" data-toggle="pill" href="#v-pills-drink" role="tab" aria-controls="v-pills-drink" aria-selected="false"><i class="fas fa-tint"></i> Eau à boire</a>
          ...
          <div class="col-md-8 ftco-animate p-4 p-md-5 d-flex align-items-center">
            ...
            <div class="tab-content pl-md-5" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active py-5" id="v-pills-master" role="tabpanel" aria-labelledby="v-pills-master-tab">
                ...
                <h2 class="mb-4">Douche et bain</h2>
...
<ul>
  ...
  <li>Utiliser des pommeaux de douche munis du label 'energy' ( moins de 12 L par minute), des réducteurs de débits, stop-douche...</li>
              ...
              <div class="tab-pane fade py-5" id="v-pills-tooth" role="tabpanel" aria-labelledby="v-pills-tooth-tab">
                <i class="icon mb-3 d-block fas fa-tooth"></i>
                <h2 class="mb-4">En se lavant les dents</h2>
              ...
              <div class="tab-pane fade py-5" id="v-pills-dish" role="tabpanel" aria-labelledby="v-pills-dish-tab">
                ...
                <h2 class="mb-4">En faisant la vaisselle</h2>
...
<p>Si vous optez pour un lave-vaisselle, regardez bien les étiquettes énergétiques qui indiquent la consommation d’eau et achetez des appareils supérieur à la classe A.</p>
              ...
              <div class="tab-pane fade py-5" id="v-pills-clothes" role="tabpanel" aria-labelledby="v-pills-clothes-tab">
                <i class="icon mb-3 d-block fas fa-socks"></i>
              ...
              <div class="tab-pane fade py-5" id="v-pills-garden" role="tabpanel" aria-labelledby="v-pills-garden-tab">
                <i class="icon mb-3 d-block fab fa-pagelines"></i>
                <h2 class="mb-4">S'occuper de son jardin</h2>
                <ul>
...
<li>Arroser le soir, pour éviter les gaspillages dus à l'évaporation (il fait plus chaud en journée) et l'évapotranspiration (rejet de vapeur par les plantes).
              ...
              <div class="tab-pane fade py-5" id="v-pills-car" role="tabpanel" aria-labelledby="v-pills-car-tab">
                <i class="icon mb-3 d-block fas fa-car"></i>
                <h2 class="mb-4">Laver sa voiture</h2>
